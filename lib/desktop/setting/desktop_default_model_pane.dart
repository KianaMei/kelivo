            ...
            child: Column(
                ...
                onPick: () async {
                  ...
                  if (sel != null) {
                    await context
                        ...
                        .setCurrentModel(sel.providerKey, sel.modelId);
                  }
                },
              ),
              ...
              _ModelCard(
                ...
                onPick: () async {
                  ...
                  if (sel != null) {
                    await context
                        .read<SettingsProvider>()
                        .setTitleModel(sel.providerKey, sel.modelId);
                  }
                },
              ...
              _ModelCard(
                ...
                onPick: () async {
                  final sel = await showModelSelector(
                    context,
                    initialProvider: settings.summaryModelProvider ?? settings.titleModelProvider ?? settings.currentModelProvider,
                    initialModelId: settings.summaryModelId ?? settings.titleModelId ?? settings.currentModelId,
                  );
                  if (sel != null) {
                    await context
                        .read<SettingsProvider>()
                        .setSummaryModel(sel.providerKey, sel.modelId);
                  }
                },
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 6),
                  Text(
                    l10n.defaultModelPageSummaryVars('{previous_summary}', '{user_messages}'),
                    style: TextStyle(color: cs.onSurface.withOpacity(0.6), fontSize: 12),
                  ),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    ...
    final bg = widget.filled
        ...
        : (_hover
            ...
            : Colors.transparent);
    final borderColor =
        widget.filled ? Colors.transparent : cs.outlineVariant.withOpacity(isDark ? 0.22 : 0.18);
