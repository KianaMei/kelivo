...
import '../services/backup/data_sync_web.dart';
...
class BackupProvider extends ChangeNotifier {
  ...
  Future<Uint8List> exportToBytes() => _dataSync.exportToBytes(_cfg);

  Future<void> restoreFromLocalBytes(Uint8List bytes, {RestoreMode mode = RestoreMode.overwrite}) =>
      _dataSync.restoreFromLocalBytes(bytes, _cfg, mode: mode);
}
