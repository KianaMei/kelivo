...
class McpTab extends StatelessWidget {
  const McpTab({super.key, required this.assistantId});
        ...
        return TactileRow(
          ...
          builder: (pressed) {
            final overlayBg = pressed
                ? (isDark ? Color.alphaBlend(Colors.white.withOpacity(0.06), bg) : Color.alphaBlend(Colors.black.withOpacity(0.05), bg))
                : bg;
            return Container(
              decoration: BoxDecoration(
                color: overlayBg,
