/// Utility to sanitize malformed Unicode surrogate pairs.
///
/// Handles common corruption patterns like stripped low surrogates from PDF
/// text extraction.
class UnicodeSanitizer {
  static const int _replacementChar = 0xFFFD;

  /// Sanitize the input string by fixing or replacing malformed surrogate pairs.
