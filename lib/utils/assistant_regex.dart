...
/// Applies all enabled regex rules from an assistant to the input string.
/// 
/// [input] - The string to transform
/// [assistant] - The assistant containing regex rules
/// [scope] - Which scope the rules should apply to (user or assistant)
/// [visual] - If true, only applies visual-only rules; if false, applies non-visual rules
